    ...
    public class ChartController : Controller
    {
        ...
        public ActionResult Count()
        {
            ...
            var countUser = new Count
            {
                ...
                Icerdeki_Kullanici = _reportService.GelenGelmeyen_Gelenlers(null, null, null, null, DateTime.Now.Date).Count,
                Disardaki_Kullanici = _reportService.GelenGelmeyen_Gelmeyens(null, null, null, null, DateTime.Now.Date).Count,
                Pasif_Kullanici = 0,
                Gecis_Yapanlar = _accessDatasService.GetAllAccessDatas().Count,
                Ziyaretci = _reportService.GetIcerdeDısardaZiyaretci(null, null, null, null,"0").Count
