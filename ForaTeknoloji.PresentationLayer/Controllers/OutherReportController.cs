...
namespace ForaTeknoloji.PresentationLayer.Controllers
{
    public class OutherReportController : Controller
    {
        ...
        {
            var liste = _reportService.GetDigerGecisListesi(null, null, null, null, null, null, null, null, null, null);
        ...
        [HttpPost]
        public ActionResult Index(List<string> Kapi, bool? Tümü, bool? TümPanel, int? Paneller, DateTime? Tarih1, DateTime? Tarih2, DateTime? Saat1, DateTime? Saat2, string Tetikleme = "", string KapiYon = "")
        {
            ...
            {
                listKulAlarm = _reportService.GetDigerGecisRaporListKullaniciAlarms(Kapi, Tümü, TümPanel, Paneller, Tarih1, Tarih2, Saat1, Saat2, Tetikleme, KapiYon);
            }
            else
            {
                liste = _reportService.GetDigerGecisListesi(Kapi, Tümü, TümPanel, Paneller, Tarih1, Tarih2, Saat1, Saat2, Tetikleme, KapiYon);
            }
            var panel = _panelSettingsService.GetAllPanelSettings();
            var model = new DigerGecisRaporListViewModel
            {
        ...
        public void DigerGecisListesi()
        {
            ...
            {
                lists = _reportService.GetDigerGecisListesi(null, null, null, null, null, null, null, null, null, null);
            }
